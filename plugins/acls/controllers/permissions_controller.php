...
class PermissionsController extends AppController {
    ...
    function admin_delete() {
        $delete_count = 0;
        if (!empty($this->data['Permission']['delete'])) {
            foreach($this->data['Permission']['delete'] as $id => $delete) {
                if ($delete == 1) {
