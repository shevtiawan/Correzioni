  ...
  <div class="inner">
    <div class="section table_section">
      ...
      <div class="title_wrapper">
        <h2><?php echo $product['Product']['title'] ?> Tabs</h2>
        <?php echo $this->Html->link($this->Html->image('add.png'),array('action'=>"add",$product_id,"ajax"),array('class'=>"nyroModal",'escape'=>false, 'style'=>"border:0px")) ?>
